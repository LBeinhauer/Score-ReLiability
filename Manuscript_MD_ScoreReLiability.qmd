...
phenomenon, $R_2$ is very low, below .25. This makes it lower than its
$R_1^3 = .574$. This would imply that for this phenomenon, the
...
size. In Beinhauer et al. (ref) we come to the conclusion that at 10
items, which the Willingness to Reconcile scale consists of, a sample
size around 33 is required to achieve sufficient power for a statistical
test of score variance heterogeneity. Most likely, the low sample size
led to implausible estimates in both true and total score variance
